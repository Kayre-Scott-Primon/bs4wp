            ...
            <?php $comments_arg = array(
                ...
                'fields' => apply_filters( 'comment_form_default_fields', array(
                    'author' => '<div class="row"><div class="col-md-6 col-sm-12"><div class="form-group">' . 
                        ...
                        ( $req ? '<span>*</span>' : '' ) . 
                        '<input id="author" class="form_control" name="author" type="text" value="' . 
                        esc_attr( $commenter['comment_author'] ) . '" ' . $aria_req = ($req) ? " aria-required='true'" : '' . '/></div></div>',
                    'email' => '<div class="col-md-6 col-sm-12"><div class="form-group">' . 
                        '<label class="control-label" for="email">' . __('Seu email') . '</label>' . 
                        ( $req ? '<span>*</span>' : '' ) . 
                        '<input class="form-control" id="email" name="email" type="text" value="' . 
                        esc_attr( $commenter['comment_author_email']) . '" ' . $aria_req = ($req) ? " aria-required='true'" : '' . '/></div></div></div>',
                ) ),
                'comment_field' => '<p>' . 
